 ...
 * @author Prof Wireman
 */
public class AIControl2 extends AbstractControl{
    ...
    protected void controlUpdate(float tpf) {
        ...
        if (forward) {
            ...
            spatial.getControl(AdvAnimationManagerControl.class).setAnimation(AdvAnimationManagerControl.Animation.Walk);
        } else if (backward) {
            walkDirection.addLocal(modelForwardDir.negate().multLocal(3));
            spatial.getControl(AdvAnimationManagerControl.class).setAnimation(AdvAnimationManagerControl.Animation.Walk);
        } else {
            spatial.getControl(AdvAnimationManagerControl.class).setAnimation(AdvAnimationManagerControl.Animation.Idle);
        }
